...
def evaluate(args, model_path1, model1, model2, model3, tokenizer, prefix=""):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        for i, feature_index in enumerate(feature_indices):
            ...
            start_logits=weight1*start_logits1+weight2*start_logits2+weight3*start_logits3
            end_logits = weight1 * end_logits1 + weight2 * end_logits2 + end_logits3 * start_logits
