...
class BiDAF:
    ...
    def build_model(self):
        ...
        for key in c_char_dict:
            ...
            #5 28*1D
            char_embedding = tf.layers.max_pooling1d(char_embedding,pool_size=2,strides=2)
            #将多通道合成一个通道
...
# #wordEmbedding的加载 和charEmbedding的卷积操作以及拼接
# def Embedding():
...
if __name__ == '__main__':
   ...
   #加载样本中样本的GLove词向量和字符char的初始化
    train_c, train_q, train_y = ds.get_chardataset('./data/squad/train-v1.1.json')
